...
const MakeAppointment = () => {
    return (
        <section className='flex items-center bg-appointment-pattern bg-cover bg-no-repeat mt-16 px-12'>
            ...
            <div className='flex-1'>
                ...
                <h2 className='text-4xl text-white capitalize font-medium my-3'>Make an appointment today</h2>
