    ...
    return (
        <section className='py-16 bg-appointment-pattern bg-cover bg-no-repeat'>
            <div className='text-center lg:mb-10'>
                <h5 className='text-2xl font-bold text-primary capitalize'>Contact Us</h5>
            ...
            <form className='flex flex-col mx-6 lg:w-1/3 lg:mx-auto mt-10 md:mx-20'>
                ...
                <input type="submit" className="btn bg-gradient-to-r from-primary to-secondary border-0 w-1/3 my-2.5 mx-auto text-white hover:bg-gradient-to-l" value="Submit" />
